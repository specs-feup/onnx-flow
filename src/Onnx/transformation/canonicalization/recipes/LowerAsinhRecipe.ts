...
export class LowerAsinhRecipe implements DecompositionRecipe {
    public readonly name = "LowerAsinh";
    public readonly targetOp = "Asinh";
    public readonly exposesControlFlow = false;
    public readonly exposesDataAccess = false
    public readonly producedOps = ["Mul", "Add", "Sqrt", "Log"];

    canApply(op: OperationNode.Class): boolean {
        return op.type === "Asinh";
    }
    ...
    apply(op: OperationNode.Class, builder: GraphBuilder): void {   
        ...
        const AddOut = builder.createOp("Add", [MulOut, OneConst], {}, output)[0];

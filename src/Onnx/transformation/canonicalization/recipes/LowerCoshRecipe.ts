...
export class LowerCoshRecipe implements DecompositionRecipe {
    public readonly name = "LowerCosh";
    public readonly targetOp = "Cosh";
    ...
    apply(op: OperationNode.Class, builder: GraphBuilder): void {
        ...
        const AddOut = builder.createOp("Add", [ExpA, ExpNegA], {}, [{ type: dtype, shape: outShape }])[0];

...
export class LowerRangeRecipe implements LoopLoweringRecipe {
    ...
    apply(
        ...
        let start = resolveRecipeInput(builder, inputs[0], valueMap, iter, axes, outShape, false, true);
        let delta = resolveRecipeInput(builder, inputs[2], valueMap, iter, axes, outShape, false, true);
        ...
        const [currentValScalar] = builder.createOp("Reshape", [currentVal, scalarShape], {}, [{type: dtype, shape: []}]);

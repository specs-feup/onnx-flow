...
export default class ConvBuilder implements LoopBuilder {
    ...
    build(
        ...
        function classifyBiasShape(
            shape: number[],
        ): "none" | "scalar" | "perChannel1D" | "perChannel4D" {
            if (!B) return "none";
            ...
            // We can easily add more forms here later (e.g., [M,1,1]) if needed.
            return "none";
        }
        ...
        // Strides & dilations
        let strides: number[] = getIntsAttr("strides") ?? (is1D ? [1] : [1, 1]); // defaults if no attribute

        let dilations: number[] = getIntsAttr("dilations") ?? (is1D ? [1] : [1, 1]);
        ...
        const W_flat = body
            ...
            .as(TensorNode);
        body.addEdge(W_in, wReshape)
            .init(new OnnxEdge.Builder(W_in.literalType, W_in.shape))
            .as(OnnxEdge);
        body.addEdge(wFlatShapeConst, wReshape)
            .init(new OnnxEdge.Builder(wFlatShapeConst.literalType, wFlatShapeConst.shape))
            .as(OnnxEdge);
        body.addEdge(wReshape, W_flat)
        ...
        const gBase = body
            ...
            .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
            .as(TensorNode);
        body.addEdge(gIdx, gMulCwOp)
            .init(new OnnxEdge.Builder(gIdx.literalType, gIdx.shape))
            .as(OnnxEdge);
        body.addEdge(CwConst, gMulCwOp)
            .init(new OnnxEdge.Builder(CwConst.literalType, CwConst.shape))
            .as(OnnxEdge);
        body.addEdge(gMulCwOp, gBase)
        ...
        for (let cRel = 0; cRel < C_per_group; cRel++) {
            ...
            const cAbs = body
                ...
                .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                .as(TensorNode);
            body.addEdge(gBase, cAbsAddOp)
                .init(new OnnxEdge.Builder(gBase.literalType, gBase.shape))
                .as(OnnxEdge);
            body.addEdge(cRelConst, cAbsAddOp)
                .init(new OnnxEdge.Builder(cRelConst.literalType, cRelConst.shape))
                .as(OnnxEdge);
            body.addEdge(cAbsAddOp, cAbs)
            ...
            for (let kh = 0; kh < kH; kh++) {
                for (let kw = 0; kw < kW; kw++) {
                    ...
                    const hPad = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(hoMulStr, hPadAddOp)
                        .init(new OnnxEdge.Builder(hoMulStr.literalType, hoMulStr.shape))
                        .as(OnnxEdge);
                    body.addEdge(khMulDil, hPadAddOp)
                        .init(new OnnxEdge.Builder(khMulDil.literalType, khMulDil.shape))
                        .as(OnnxEdge);
                    body.addEdge(hPadAddOp, hPad)
                    ...
                    const wPad = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(woMulStr, wPadAddOp)
                        .init(new OnnxEdge.Builder(woMulStr.literalType, woMulStr.shape))
                        .as(OnnxEdge);
                    body.addEdge(kwMulDil, wPadAddOp)
                        .init(new OnnxEdge.Builder(kwMulDil.literalType, kwMulDil.shape))
                        .as(OnnxEdge);
                    body.addEdge(wPadAddOp, wPad)
                    ...
                    const ncPlus = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(nMulC, ncPlusOp)
                        .init(new OnnxEdge.Builder(nMulC.literalType, nMulC.shape))
                        .as(OnnxEdge);
                    body.addEdge(cAbs, ncPlusOp)
                        .init(new OnnxEdge.Builder(cAbs.literalType, cAbs.shape))
                        .as(OnnxEdge);
                    body.addEdge(ncPlusOp, ncPlus)
                    ...
                    const mulHpad = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(ncPlus, mulHpadOp)
                        .init(new OnnxEdge.Builder(ncPlus.literalType, ncPlus.shape))
                        .as(OnnxEdge);
                    body.addEdge(HpadConst, mulHpadOp)
                        .init(new OnnxEdge.Builder(HpadConst.literalType, HpadConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(mulHpadOp, mulHpad)
                    ...
                    const addHpad = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(mulHpad, addHpadOp)
                        .init(new OnnxEdge.Builder(mulHpad.literalType, mulHpad.shape))
                        .as(OnnxEdge);
                    body.addEdge(hPad, addHpadOp)
                        .init(new OnnxEdge.Builder(hPad.literalType, hPad.shape))
                        .as(OnnxEdge);
                    body.addEdge(addHpadOp, addHpad)
                    ...
                    const mulWpad = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(addHpad, mulWpadOp)
                        .init(new OnnxEdge.Builder(addHpad.literalType, addHpad.shape))
                        .as(OnnxEdge);
                    body.addEdge(WpadConst, mulWpadOp)
                        .init(new OnnxEdge.Builder(WpadConst.literalType, WpadConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(mulWpadOp, mulWpad)
                    ...
                    const xIdx = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(mulWpad, xIdxAddOp)
                        .init(new OnnxEdge.Builder(mulWpad.literalType, mulWpad.shape))
                        .as(OnnxEdge);
                    body.addEdge(wPad, xIdxAddOp)
                        .init(new OnnxEdge.Builder(wPad.literalType, wPad.shape))
                        .as(OnnxEdge);
                    body.addEdge(xIdxAddOp, xIdx)
                    ...
                    const xVec = body
                        ...
                        .as(TensorNode);
                    body.addEdge(X_flat, gatherXOp)
                        .init(new OnnxEdge.Builder(X_flat.literalType, X_flat.shape))
                        .as(OnnxEdge);
                    body.addEdge(xIdxUnsq, gatherXOp)
                        .init(new OnnxEdge.Builder(xIdxUnsq.literalType, xIdxUnsq.shape))
                        .as(OnnxEdge);
                    body.addEdge(gatherXOp, xVec)
                    ...
                    const mMulCw = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(mIdx, mMulCwOp)
                        .init(new OnnxEdge.Builder(mIdx.literalType, mIdx.shape))
                        .as(OnnxEdge);
                    body.addEdge(CwConst, mMulCwOp)
                        .init(new OnnxEdge.Builder(CwConst.literalType, CwConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(mMulCwOp, mMulCw)
                    ...
                    const mPlusCrel = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(mMulCw, mPlusCrelOp)
                        .init(new OnnxEdge.Builder(mMulCw.literalType, mMulCw.shape))
                        .as(OnnxEdge);
                    body.addEdge(cRelConst, mPlusCrelOp)
                        .init(new OnnxEdge.Builder(cRelConst.literalType, cRelConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(mPlusCrelOp, mPlusCrel)
                    ...
                    const mulkH = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(mPlusCrel, mulkHOp)
                        .init(new OnnxEdge.Builder(mPlusCrel.literalType, mPlusCrel.shape))
                        .as(OnnxEdge);
                    body.addEdge(kHConst, mulkHOp)
                        .init(new OnnxEdge.Builder(kHConst.literalType, kHConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(mulkHOp, mulkH)
                    ...
                    const addKh = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(mulkH, addKhOp)
                        .init(new OnnxEdge.Builder(mulkH.literalType, mulkH.shape))
                        .as(OnnxEdge);
                    body.addEdge(khConst, addKhOp)
                        .init(new OnnxEdge.Builder(khConst.literalType, khConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(addKhOp, addKh)
                    ...
                    const mulkW = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(addKh, mulkWOp)
                        .init(new OnnxEdge.Builder(addKh.literalType, addKh.shape))
                        .as(OnnxEdge);
                    body.addEdge(kWConst, mulkWOp)
                        .init(new OnnxEdge.Builder(kWConst.literalType, kWConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(mulkWOp, mulkW)
                    ...
                    const wIdx = body
                        ...
                        .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(mulkW, wIdxAddOp)
                        .init(new OnnxEdge.Builder(mulkW.literalType, mulkW.shape))
                        .as(OnnxEdge);
                    body.addEdge(kwConst, wIdxAddOp)
                        .init(new OnnxEdge.Builder(kwConst.literalType, kwConst.shape))
                        .as(OnnxEdge);
                    body.addEdge(wIdxAddOp, wIdx)
                    ...
                    const wVec = body
                        ...
                        .init(new TensorNode.Builder(elemTy, [1], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(W_flat, gatherWOp)
                        .init(new OnnxEdge.Builder(W_flat.literalType, W_flat.shape))
                        .as(OnnxEdge);
                    body.addEdge(wIdxUnsq, gatherWOp)
                        .init(new OnnxEdge.Builder(wIdxUnsq.literalType, wIdxUnsq.shape))
                        .as(OnnxEdge);
                    body.addEdge(gatherWOp, wVec)
                    ...
                    const term = body
                        ...
                        .init(new TensorNode.Builder(elemTy, [1], "intermediate"))
                        .as(TensorNode);
                    body.addEdge(xVec, mulOp)
                        .init(new OnnxEdge.Builder(xVec.literalType, xVec.shape))
                        .as(OnnxEdge);
                    body.addEdge(wVec, mulOp)
                        .init(new OnnxEdge.Builder(wVec.literalType, wVec.shape))
                        .as(OnnxEdge);
                    body.addEdge(mulOp, term)
                    ...
                    if (!accVec) {
                        ...
                        const accOut = body
                            ...
                            .init(new TensorNode.Builder(elemTy, [1], "intermediate"))
                            .as(TensorNode);
                        body.addEdge(accVec, addOp)
                            .init(new OnnxEdge.Builder(accVec.literalType, accVec.shape))
                            .as(OnnxEdge);
                        body.addEdge(term, addOp)
                            .init(new OnnxEdge.Builder(term.literalType, term.shape))
                            .as(OnnxEdge);
                        body.addEdge(addOp, accOut)
        ...
        if (B_in && biasKind !== "none") {
            ...
            if (biasKind === "scalar") {
                ...
                const mIdxUnsq = unsqueezeIdx(body, mIdx, axes0, `conv_mIdx_unsq_${conv.id}`);

                const axisForB = biasKind === "perChannel1D" ? 0 : 1;

                const gatherBOp = body
                    .addNode(uniq(body, `conv_gatherB_${conv.id}`))
                    .init(new OperationNode.Builder("Gather", [B_in, mIdxUnsq], { axis: axisForB }))
                    .as(OperationNode);
            ...
            body.addEdge(accVec, addBiasOp)
                .init(new OnnxEdge.Builder(accVec.literalType, accVec.shape))
                .as(OnnxEdge);
            body.addEdge(biasScalar, addBiasOp)
                .init(new OnnxEdge.Builder(biasScalar.literalType, biasScalar.shape))
                .as(OnnxEdge);
            body.addEdge(addBiasOp, yBias)

...
class AveragePoolBuilder implements LoopBuilder {
    ...
    build(
        ...
        // Fallback for edge cases (edge cases for this purpose) where the
        ...
        const [r0Const, r1Const, r2Const, r3Const] = decodeMixedRadix(body, iter, dims, "rDecode");
        ...
        const hoMulStrideTensor = body
            ...
            .as(TensorNode);
        body.addEdge(hoIdx, hoMulStride).init(new OnnxEdge.Builder(hoIdx.literalType, hoIdx.shape));
        body.addEdge(strideHConst, hoMulStride).init(
            new OnnxEdge.Builder(strideHConst.literalType, strideHConst.shape),
        );
        body.addEdge(hoMulStride, hoMulStrideTensor).init(
            new OnnxEdge.Builder(hoMulStrideTensor.literalType, hoMulStrideTensor.shape),
        );
        ...
        const hStart = body
            ...
            .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
            .as(TensorNode);
        body.addEdge(hoMulStrideTensor, hStartOp).init(
            new OnnxEdge.Builder(hoMulStrideTensor.literalType, hoMulStrideTensor.shape),
        );
        body.addEdge(padTopConst, hStartOp).init(
            new OnnxEdge.Builder(padTopConst.literalType, padTopConst.shape),
        );
        body.addEdge(hStartOp, hStart).init(new OnnxEdge.Builder(hStart.literalType, hStart.shape));
        ...
        const woMulStrideTensor = body
            ...
            .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
            .as(TensorNode);
        body.addEdge(woIdx, woMulStride).init(new OnnxEdge.Builder(woIdx.literalType, woIdx.shape));
        body.addEdge(strideWConst, woMulStride).init(
            new OnnxEdge.Builder(strideWConst.literalType, strideWConst.shape),
        );
        body.addEdge(woMulStride, woMulStrideTensor).init(
            new OnnxEdge.Builder(woMulStrideTensor.literalType, woMulStrideTensor.shape),
        );
        ...
        const wStart = body
            ...
            .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
            .as(TensorNode);
        body.addEdge(woMulStrideTensor, wStartOp).init(
            new OnnxEdge.Builder(woMulStrideTensor.literalType, woMulStrideTensor.shape),
        );
        body.addEdge(padLeftConst, wStartOp).init(
            new OnnxEdge.Builder(padLeftConst.literalType, padLeftConst.shape),
        );
        body.addEdge(wStartOp, wStart).init(new OnnxEdge.Builder(wStart.literalType, wStart.shape));
        ...
        for (let kh = 0; kh < kH; kh++) {
            for (let kwi = 0; kwi < kW; kwi++) {
                ...
                const hVal = body
                    ...
                    .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(hStart, hOp).init(
                    new OnnxEdge.Builder(hStart.literalType, hStart.shape),
                );
                body.addEdge(khConst, hOp).init(
                    new OnnxEdge.Builder(khConst.literalType, khConst.shape),
                );
                body.addEdge(hOp, hVal).init(new OnnxEdge.Builder(hVal.literalType, hVal.shape));
                ...
                const wVal = body
                    ...
                    .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(wStart, wOp).init(
                    new OnnxEdge.Builder(wStart.literalType, wStart.shape),
                );
                body.addEdge(kwConst, wOp).init(
                    new OnnxEdge.Builder(kwConst.literalType, kwConst.shape),
                );
                body.addEdge(wOp, wVal).init(new OnnxEdge.Builder(wVal.literalType, wVal.shape));
                ...
                body.addEdge(HConst, hLtHOp).init(
                    new OnnxEdge.Builder(HConst.literalType, HConst.shape),
                );
                ...
                body.addEdge(WConst, wLtWOp).init(
                    new OnnxEdge.Builder(WConst.literalType, WConst.shape),
                );
                ...
                const inBounds = body
                    ...
                    .init(new TensorNode.Builder(DataType.BOOL, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(hIn, inBoundsOp).init(
                    new OnnxEdge.Builder(hIn.literalType, hIn.shape),
                );
                body.addEdge(wIn, inBoundsOp).init(
                    new OnnxEdge.Builder(wIn.literalType, wIn.shape),
                );
                body.addEdge(inBoundsOp, inBounds).init(
                    new OnnxEdge.Builder(inBounds.literalType, inBounds.shape),
                );
                ...
                body.addEdge(Hminus1Const, hMinOp).init(
                    new OnnxEdge.Builder(Hminus1Const.literalType, Hminus1Const.shape),
                );
                ...
                const hClamped = body
                    ...
                    .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(hMin, hClampOp).init(
                    new OnnxEdge.Builder(hMin.literalType, hMin.shape),
                );
                body.addEdge(zeroInt, hClampOp).init(
                    new OnnxEdge.Builder(zeroInt.literalType, zeroInt.shape),
                );
                body.addEdge(hClampOp, hClamped).init(
                    new OnnxEdge.Builder(hClamped.literalType, hClamped.shape),
                );
                ...
                body.addEdge(Wminus1Const, wMinOp).init(
                    new OnnxEdge.Builder(Wminus1Const.literalType, Wminus1Const.shape),
                );
                ...
                const wClamped = body
                    ...
                    .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(wMin, wClampOp).init(
                    new OnnxEdge.Builder(wMin.literalType, wMin.shape),
                );
                body.addEdge(zeroInt, wClampOp).init(
                    new OnnxEdge.Builder(zeroInt.literalType, zeroInt.shape),
                );
                body.addEdge(wClampOp, wClamped).init(
                    new OnnxEdge.Builder(wClamped.literalType, wClamped.shape),
                );
                ...
                body.addEdge(nUnsq, idxCat).init(
                    new OnnxEdge.Builder(nUnsq.literalType, nUnsq.shape),
                );
                body.addEdge(cUnsq, idxCat).init(
                    new OnnxEdge.Builder(cUnsq.literalType, cUnsq.shape),
                );
                body.addEdge(hUnsq, idxCat).init(
                    new OnnxEdge.Builder(hUnsq.literalType, hUnsq.shape),
                );
                body.addEdge(wUnsq, idxCat).init(
                    new OnnxEdge.Builder(wUnsq.literalType, wUnsq.shape),
                );
                body.addEdge(idxCat, idxVec).init(
                    new OnnxEdge.Builder(idxVec.literalType, idxVec.shape),
                );
                ...
                body.addEdge(X_in, gather).init(new OnnxEdge.Builder(X_in.literalType, X_in.shape));
                body.addEdge(indices, gather).init(
                    new OnnxEdge.Builder(indices.literalType, indices.shape),
                );
                body.addEdge(gather, gathered).init(
                    new OnnxEdge.Builder(gathered.literalType, gathered.shape),
                );
                ...
                const maskFloat = body
                    ...
                    .init(new TensorNode.Builder(elemTy, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(inBounds, maskFloatOp).init(
                    new OnnxEdge.Builder(inBounds.literalType, inBounds.shape),
                );
                body.addEdge(maskFloatOp, maskFloat).init(
                    new OnnxEdge.Builder(maskFloat.literalType, maskFloat.shape),
                );
                ...
                const maskInt = body
                    ...
                    .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(inBounds, maskIntOp).init(
                    new OnnxEdge.Builder(inBounds.literalType, inBounds.shape),
                );
                body.addEdge(maskIntOp, maskInt).init(
                    new OnnxEdge.Builder(maskInt.literalType, maskInt.shape),
                );
                ...
                const contrib = body
                    ...
                    .init(new TensorNode.Builder(elemTy, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(gathered, contribOp).init(
                    new OnnxEdge.Builder(gathered.literalType, gathered.shape),
                );
                body.addEdge(maskFloat, contribOp).init(
                    new OnnxEdge.Builder(maskFloat.literalType, maskFloat.shape),
                );
                body.addEdge(contribOp, contrib).init(
                    new OnnxEdge.Builder(contrib.literalType, contrib.shape),
                );
                ...
                const sumNext = body
                    ...
                    .init(new TensorNode.Builder(elemTy, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(sumVal, addOp).init(
                    new OnnxEdge.Builder(sumVal.literalType, sumVal.shape),
                );
                body.addEdge(contrib, addOp).init(
                    new OnnxEdge.Builder(contrib.literalType, contrib.shape),
                );
                body.addEdge(addOp, sumNext).init(
                    new OnnxEdge.Builder(sumNext.literalType, sumNext.shape),
                );
                sumVal = sumNext;
                ...
                const countNext = body
                    ...
                    .init(new TensorNode.Builder(DataType.INT64, [], "intermediate"))
                    .as(TensorNode);
                body.addEdge(countVal, countAddOp).init(
                    new OnnxEdge.Builder(countVal.literalType, countVal.shape),
                );
                body.addEdge(maskInt, countAddOp).init(
                    new OnnxEdge.Builder(maskInt.literalType, maskInt.shape),
                );
                body.addEdge(countAddOp, countNext).init(
                    new OnnxEdge.Builder(countNext.literalType, countNext.shape),
                );
                countVal = countNext;
            }
        }
        ...
        const divisorCastTensor = body
            ...
            .init(new TensorNode.Builder(elemTy, [], "intermediate"))
            .as(TensorNode);
        body.addEdge(divisor, divisorCast).init(
            new OnnxEdge.Builder(divisor.literalType, divisor.shape),
        );
        body.addEdge(divisorCast, divisorCastTensor).init(
            new OnnxEdge.Builder(divisorCastTensor.literalType, divisorCastTensor.shape),
        );
        ...
        const avgOut = body
            ...
            .init(new TensorNode.Builder(elemTy, [], "intermediate"))
            .as(TensorNode);
        body.addEdge(sumVal, avgOp).init(new OnnxEdge.Builder(sumVal.literalType, sumVal.shape));
        body.addEdge(divisorCastTensor, avgOp).init(
            new OnnxEdge.Builder(divisorCastTensor.literalType, divisorCastTensor.shape),
        );
        body.addEdge(avgOp, avgOut).init(new OnnxEdge.Builder(avgOut.literalType, avgOut.shape));

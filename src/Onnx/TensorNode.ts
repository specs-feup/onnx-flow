...
namespace TensorNode {
  ...
  export type TensorKind = "input" | "output" | "initializer" | "intermediate" | "constant" | "index" | "index_aux";
  ...
  > extends BaseNode.Class<D, S> {
    ...
    setShape(shape: (number | undefined)[]): void {
  ...
  export class Builder implements Node.Builder<Data, ScratchData> {
    ...
    private shape: (number | undefined)[];
    ...
    constructor(literalType: number, shape: (number | undefined)[], type: TensorKind, constantValue?: TensorProto, originalInitializer?: TensorProto, extraAttrs?: AttributeProto[]) {

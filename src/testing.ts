...
async function runModel() {
  ...
  function getRandomArray(shape: number[], elemType: string): Float32Array | Int32Array | BigInt64Array | Uint8Array | Int8Array | Uint16Array | Int16Array | Uint32Array | Float64Array {
  ...
  const generatedOutputValues = Object.values(generatedOutput).map((value: any) => value.toString());
